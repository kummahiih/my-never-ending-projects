...
from kuvio import *
from kuviot_looti import Kuviot
...
print "oletetetaan, että 100 v päästä metsästä saa myytynä saman hinnan eli",  investoitu 
